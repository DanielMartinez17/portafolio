    ...
    <section id="prove-product-cat-config">
        <div class="container">
            <div class="page-header">
              <h1>Panel de administración <small class="tittles-pages-logo">Mr. Potato</small></h1>
            </div>
            <!-- Nav tabs -->
                            ...
                            <br><br>
                             <div class="panel panel-info">
                              ...
                              <div class="table-responsive">
                                  ...
                                  <form method="POST" action=registro/registro_PDF.php>
                                    <p align="right"><input type="submit" value="ver registro" name="registro"></p>
                                  </form>
                              </div>
                            </div>
                        </div>
